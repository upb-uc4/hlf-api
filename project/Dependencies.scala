...
object Dependencies {
  // libraries
  private val hyperledger_sdk = "org.hyperledger.fabric-sdk-java" % "fabric-sdk-java" % "2.2.1"
  private val hyperledger_gateway = "org.hyperledger.fabric" % "fabric-gateway-java" % "2.2.0"
