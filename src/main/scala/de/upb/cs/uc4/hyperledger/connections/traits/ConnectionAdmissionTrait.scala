...
trait ConnectionAdmissionTrait extends ConnectionTrait {
  ...
  def getProposalAddAdmission(certificate: String, admission: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalDropAdmission(certificate: String, admissionId: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalGetAdmission(certificate: String, enrollmentId: String = "", courseId: String = "", moduleId: String = ""): (String, Array[Byte])
