...
trait ConnectionGroupTrait extends ConnectionTrait {
  ...
  def getProposalAddUserToGroup(certificate: String, enrollmentId: String, groupId: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalRemoveUserFromGroup(certificate: String, enrollmentId: String, groupId: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalRemoveUserFromAllGroups(certificate: String, enrollmentId: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalGetAllGroups(certificate: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalGetUsersForGroup(certificate: String, groupId: String): (String, Array[Byte])
  ...
  @throws[HyperledgerExceptionTrait]
  @throws[TransactionExceptionTrait]
  def getProposalGetGroupsForUser(certificate: String, enrollmentId: String): (String, Array[Byte])
