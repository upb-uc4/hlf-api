...
object RegistrationManager {
  ...
  @throws[Exception]
  def register(tlsCert: Path, caURL: String, userName: String, adminName: String, adminWalletPath: Path, organisationId: String, organizationName: String): String = {
    ...
    try {
      ...
      admin = new User() {
        ...
        override def getAffiliation: String = organizationName
    ...
    try {
      ...
      registrationRequest.setAffiliation(organizationName)
