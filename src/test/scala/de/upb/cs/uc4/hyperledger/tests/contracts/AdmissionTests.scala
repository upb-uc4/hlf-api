      ...
      matConnection: ConnectionMatriculationTrait =>
        {
          ...
          // approve as Users
          initializeOperation(testUser1).proposeTransaction(username, "UC4.MatriculationData", "addMatriculationData", mat1)
          initializeOperation(testUser2).proposeTransaction(username, "UC4.MatriculationData", "addMatriculationData", mat2)
