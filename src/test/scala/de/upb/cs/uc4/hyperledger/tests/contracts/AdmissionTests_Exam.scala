...
class AdmissionTests_Exam extends TestBase {
  ...
  def testCourseAdmission2(studentId: String): String = TestDataAdmission.validCourseAdmission(studentId, testCourse2, testModule2, "")
  def testCourseAdmission3(studentId: String): String = TestDataAdmission.validCourseAdmission(studentId, testCourse3, testModule3, "")
  def testCourseAdmission4(studentId: String): String = TestDataAdmission.validCourseAdmission(studentId, testCourse4, testModule3, "")
  def testCourseAdmission5(studentId: String): String = TestDataAdmission.validCourseAdmission(studentId, testCourse5, testModule4, "")
  def testCourseAdmission6(studentId: String): String = TestDataAdmission.validCourseAdmission(studentId, testCourse6, testModule1, "")
  ...
  override def beforeAll(): Unit = {
    ...
    TestSetup.establishAdmissions(initializeAdmission(), initializeOperation, Seq(student1),
      Seq(testCourseAdmission1(student1), testCourseAdmission2(student1), testCourseAdmission3(student1),
        testCourseAdmission4(student1), testCourseAdmission5(student1), testCourseAdmission6(student1)))
    TestSetup.establishAdmissions(initializeAdmission(), initializeOperation, Seq(student2),
      Seq(testCourseAdmission1(student2), testCourseAdmission2(student2), testCourseAdmission3(student2),
        testCourseAdmission4(student2), testCourseAdmission5(student2), testCourseAdmission6(student2)))
  }
