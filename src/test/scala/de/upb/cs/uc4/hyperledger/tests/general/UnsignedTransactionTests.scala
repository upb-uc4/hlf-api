  ...
  "The ConnectionCertificate" when {
    "querying for an unsigned proposal" should {
      "return an unsigned proposal" in {
        ...
        val jsonRegulation = TestDataExaminationRegulation.validExaminationRegulation("UnsignedTransactionTests_ComputerScience", Seq(TestDataExaminationRegulation.getModule("M1")), true)
