    ...
    "invoked with addExam incorrectly " should {
      val testDataDeny: Seq[(String, String, String, String, String, String, Int, String, String, String, String)] = Seq(
        ...
        ("deny adding invalid Exam [date lastYear]", s"C.1:$testUser2:$testModule1:Written Exam:6:2020-03-14T12:00:00.000Z", "C.1", testUser2, testModule1, "Written Exam", 6, "2020-03-14T12:00:00.000Z", "2020-03-10T12:00:00.000Z", "2020-03-12T12:00:00.000Z",
          "{\"type\":\"HLUnprocessableEntity\",\"title\":\"Thefollowingparametersdonotconformtothespecifiedformat\",\"invalidParams\":[{\"name\":\"exam.date\",\"reason\":\"Theexamdatehastobeinthefutureandafteradmittbaleanddroppabledate.\"},{\"name\":\"exam.admittableAt\",\"reason\":\"Theadmittabledatehastobeinthefutureandbeforedroppabledateanddateoftheexam.\"},{\"name\":\"exam.droppableAt\",\"reason\":\"Thedroppabledatehastobeinthefutureandafteradmittabledateandbeforedateoftheexam.\"}]}"),
        ("deny adding invalid Exam [admittableDate lastYear]", s"C.1:$testUser2:$testModule1:Written Exam:6:2021-03-14T12:00:00.000Z", "C.1", testUser2, testModule1, "Written Exam", 6, "2021-03-14T12:00:00.000Z", "2020-03-10T12:00:00.000Z", "2021-03-12T12:00:00.000Z",
          "{\"type\":\"HLUnprocessableEntity\",\"title\":\"Thefollowingparametersdonotconformtothespecifiedformat\",\"invalidParams\":[{\"name\":\"exam.admittableAt\",\"reason\":\"Theadmittabledatehastobeinthefutureandbeforedroppabledateanddateoftheexam.\"}]}"),
        ("deny adding invalid Exam [droppableDate lastYear]", s"C.1:$testUser2:$testModule1:Written Exam:6:2021-03-14T12:00:00.000Z", "C.1", testUser2, testModule1, "Written Exam", 6, "2021-03-14T12:00:00.000Z", "2020-03-10T12:00:00.000Z", "2020-03-12T12:00:00.000Z",
          "{\"type\":\"HLUnprocessableEntity\",\"title\":\"Thefollowingparametersdonotconformtothespecifiedformat\",\"invalidParams\":[{\"name\":\"exam.admittableAt\",\"reason\":\"Theadmittabledatehastobeinthefutureandbeforedroppabledateanddateoftheexam.\"},{\"name\":\"exam.droppableAt\",\"reason\":\"Thedroppabledatehastobeinthefutureandafteradmittabledateandbeforedateoftheexam.\"}]}"),
